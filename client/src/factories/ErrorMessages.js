export default {
  ...
  noteam: {
    component: 'create-or-join-team',
    error: `
      We weren't able to identify the team you belong to. If you think this is an
      error, please contact your team administrator to ensure you're added
      to the team.
    `
  },
