<template lang="pug">
  div
    div(v-if="!selectedIntegration")
      ...
      typeahead-input(:params="{ src: '/api/1.0/integrations/salesforce/team/objects/get', keysFromResponse: 'records', showProp: 'object_name', minChars: 1 }",@isEmpty="isEmpty",@onError="fetchError",@onHit="selectInt")
    div(v-if="selectedIntegration")
      div
        ...
        typeahead-input(:params="{ src: '/api/1.0/integrations/salesforce/records/get?int_id=' + selectedIntegration.id, keysFromResponse: 'records', showProp: 'Name', minChars: 3 }",@isEmpty="isEmpty",@onError="fetchError",@onHit="selectRecord")
